...
import com.example.demo.smswake.model.CMPPRequestBody;
...
public class CMPPSubmit implements CMPPRequestBody {
	...
	public byte[] getRequestBody() {
		...
		// model[cur] = submit.fee_terminal_type;
		// cur += 1;
		...
		// model[cur] = submit.dest_terminal_type;
		// cur += 1;
		...
		// System.arraycopy(linkID, 0, model, cur, 20);
